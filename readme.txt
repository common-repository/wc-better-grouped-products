=== Better Grouped Products For WooCommerce ===
...
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don't need to leave your web browser. To do an automatic install of Better Grouped Products For WooCommerce, log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.

In the search field type "Better Grouped Products For WooCommerce"  and click Search Plugins. Once you've found our plugin you can view details about it such as the the point release, rating and description. Most importantly of course, you can install it by simply clicking "Install Now"
 ...
 * via Admin Dashboard:
 * Go to 'Plugins > Add New', search for "Better Grouped Products For WooCommerce", click "install"
